...
The live example composes **Button as the trigger**: a Button animates through `hover` → `press` states (the "click"), the dropdown panel opens right after the press lands, and rows animate through hover → press as the user picks an action. Copy the code to drop it into your own composition.

<LiveExample name="dropdown-menu-example" />
